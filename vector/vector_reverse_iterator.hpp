...
/*   Updated: 2023/03/02 15:42:26 by ael-hayy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
	...
	template <class A> vector_reverse_iterator(const vector_reverse_iterator<A>& other)
	{
		_ptr = other.base();	
	}
	...
	template <class ittt> bool operator== (const vector_reverse_iterator<ittt>& rhs)
	{
		return (this->base() == rhs.base());
	}
	template<class itt> bool operator != (const vector_reverse_iterator<itt>& other)
	{
		return (_ptr != other.base());
	}
	difference_type operator+ (const vector_reverse_iterator& other) const {
